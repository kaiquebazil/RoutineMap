...
import { ArrowRight, Calendar, Languages, MessageSquareText, Target, Sparkles, BookOpen, Zap, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-violet-50/30 dark:to-violet-950/20">
      ...
      <section className="container mx-auto px-4 pt-20 pb-16 md:pt-28 md:pb-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            Organize suas rotinas de estudo, acompanhe hábitos linguísticos, reflita sobre seu progresso e centralize todas as suas referências em um único painel inspirado no Notion. Sem cadastro, sem senha — seus dados ficam salvos no seu navegador.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="mt-4 text-lg text-white/90">Sem cadastro, sem senha. Acesse seu dashboard, organize suas rotinas e comece a estudar agora mesmo.</p>
